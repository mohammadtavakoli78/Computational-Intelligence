...
class Evolution:
    ...
    def generate_new_population(self, num_players, prev_players=None):
        ...
        if first_generation:
            ...
            prev_players_copy = prev_players
            ...
            for i in range(num_players):
                ...
                child = self.clone_player(parent[i])
    ...
    def crossover(self, parent1, parent2):
        ...
        child1.nn.b1[int(len(parent1_b1) / 2):int(len(parent1_b1))] = parent2_b1[int(len(parent1_b1) / 2):int(len(parent1_b1))]
        child2.nn.b1[0:int(len(parent1_b1) / 2)] = parent2_b1[0:int(len(parent1_b1) / 2)]
        child2.nn.b1[int(len(parent1_b1) / 2):int(len(parent1_b1))] = parent1_b1[int(len(parent1_b1) / 2):int(len(parent1_b1))]

        child1.nn.b2[0:int(len(parent1_b2) / 2)] = parent1_b2[0:int(len(parent1_b2) / 2)]
        child1.nn.b2[int(len(parent1_b2) / 2):int(len(parent1_b2))] = parent2_b2[int(len(parent1_b2) / 2):int(len(parent1_b2))]
        child2.nn.b2[0:int(len(parent1_b2) / 2)] = parent2_b2[0:int(len(parent1_b2) / 2)]
        child2.nn.b2[int(len(parent1_b2) / 2):int(len(parent1_b2))] = parent1_b2[int(len(parent1_b2) / 2):int(len(parent1_b2))]
